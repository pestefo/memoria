...
\par Finalmente el experimento de agrupamiento consistió en ejecutar el algoritmo de agrupación aglomerativo jerárquico para cada distancia y cada similitud interna mínima, con lo cual se obtuvo 15 particiones de {\tt ROMondrianViewBuilderTest}. Luego de evaluados los resultados (ver \apref{exp-clustering}) se obtuvo que los mejores resultados se obtuvieron con: \textbf{similitud interna mínima} de \textbf{85\%} y como métrica de distancia \textbf{Average Link}.
...
\fig{H}{0.75}{impl/comparator.pdf}{Diagrama de clases del paquete {\tt TestSurgeon-Comparator}}
\fig{H}{0.75}{impl/clustering.pdf}{Diagrama de clases del paquete {\tt TestSurgeon-Clustering}}
