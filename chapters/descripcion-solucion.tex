...
\par Para ejemplificar el uso de TestSurgeon se muestra a continuación un ejemplo ejecutando TestSurgeon sobre el software: \emph{Roassal}.
...
\par Una vez concluida la etapa de profiling, se desplega una ventana con cuatro zonas principales(ver \figref{caso-uso/2.png}): 
\begin{itemize}
...
% - Figura: Visualizacion Metodos (alto y ancho)
...
\fig{h}{0.85}{pop-up-view.pdf}{Vemtana emergente con detalles de las métricas para el método {\tt deltaFor:}.}
