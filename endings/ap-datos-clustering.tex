...
%% Poner imagen del clustering escogido acá y referenciar alla.
%% Hablar numero total de comparaciones y % de comparaciones innecesarias menos.


%== Figura debe ir despues de la mega-figura
